...
class WinPollster(object):
    ...
    def __init__(self):
        ...
        self._cs = c.Win32_ComputerSystem()
        self._os = c.Win32_OperatingSystem()
        self._pfu = c.Win32_PageFileUsage()
        self.hostname = self._os.CSName
    ...
    def get_net(self):
        items = self._com.AddEnum(obj, "Win32_PerfRawData_Tcpip_NetworkInterface").objectSet
...
#
##    def get_pql(self):
##        #Get ProcessorQueueLength
##        c = wmi.WMI ()
##        com = client.Dispatch("WbemScripting.SWbemRefresher")
##        obj = client.GetObject("winmgmts:\\root\cimv2")
##        items = com.AddEnum(obj, "Win32_PerfFormattedData_PerfOS_System").objectSet
##
##        com.Refresh()
##        for item in items:
##            print item.ProcessorQueueLength
